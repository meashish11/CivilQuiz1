...
function optionSelected(answer){
    ...
    if(userAns == correctAns){ 
        ...
        // if wrong answer is chosen, automatically select the right answer
...
function showResultBox() {
    ...
    if(userScore > 3) {
        let scoreTag = '<span>Congratulations, You got only <p>' + userScore + '</p> out of <p>' + questions.length + '</p></span>'
